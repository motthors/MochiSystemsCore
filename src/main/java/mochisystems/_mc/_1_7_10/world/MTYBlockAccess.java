package mochisystems._mc._1_7_10.world;
...
import mochisystems._mc._1_7_10.tileentity.TileEntityBeaconWrapper;
...
//					Logger.debugInfo("MTYBlockAccess : "+type.getLocalizedName()+"\t {"+x+"."+y+"."+z+"}");
                    ...
                    if(nbt.hasKey(tileName))
                    {
                        ...
                        if(tile!=null)
                        {
                            ...
                            if(tile instanceof TileEntityBeacon)tile = new TileEntityBeaconWrapper(this, getBlockOrgPos(x, y-1, z));
